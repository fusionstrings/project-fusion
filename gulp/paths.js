...
export default {
  ...
  styleguideOverview: `${appRoot}docs/styleguide/readme.md`,
  ...
  outputStyleguide: `${outputRoot}docs/styleguide`,
  outputStyleguidePath: '/docs/styleguide',
  outputEsdoc: `${outputRoot}docs/esdoc`,
  tmp: tmpRoot,
  tmpStyle: `${tmpRoot}styles`,
  tmpStyleguide: `${tmpRoot}docs/styleguide`,
